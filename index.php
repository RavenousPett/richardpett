...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>RichardPett.com - Web Developer</title>
    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner" id="nav-bar">
                <div class="container">
                    <a class="brand" href="/">Richard Pett</a>
                    <p class="strapline"> - Web Develpment Porfolio</p>
                </div>
            </div>
        </div>
        ...
        <div class="shadow-bottom">  </div><!-- end of shadow top-->
            ...
            <div class="row">
                ...
                <div class="span4">
                    <div class="thumb-wrap">
                        <img class="thumb-corner" src="images/thumb-corner.png" />
                        <img class="thumb-pic" src="projects/intense/thumb.jpg" />
                    </div>
                    <h2>Heading</h2>
                    <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                    <p><a class="btn" href="#">View project &raquo;</a></p>
                </div>
                <div class="span4">
                    <div class="thumb-wrap">
                        <img class="thumb-corner" src="images/thumb-corner.png" />
